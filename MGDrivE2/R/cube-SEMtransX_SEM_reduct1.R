...
#' been completely reduced, removing all resistance alleles. There are 3 possible alleles at the first site:
#' \itemize{
...
#' }
#'
#' This provides a total genotype count of 54, however, there are only 36 viable
#' female genotypes and 18 viable male genotypes. Genotypes are written (site 1)(site 1)(site 2)(site 2),
...
#' @export
cubeSEMtransX_SEMReduct1 <- function(pF=1,
                                     aF=1, cF=1,
                                     xF=1,
                                     pM=pF,
                                     aM=aF, cM=cF,
  ...
  genoF <- c('WWXX','GWXX','VWXX','GGXX','GVXX','VVXX','WWHX','GWHX','VWHX','GGHX','GVHX',
             'VVHX','WWEX','GWEX','VWEX','GGEX','GVEX','VVEX','WWHH','GWHH','VWHH','GGHH',
             'GVHH','VVHH','WWEH','GWEH','VWEH','GGEH','GVEH','VVEH','WWEE','GWEE','VWEE',
             'GGEE','GVEE','VVEE')
  genoM <- c('WWXY','GWXY','VWXY','GGXY','GVXY','VVXY','WWHY','GWHY','VWHY','GGHY','GVHY',
             'VVHY','WWEY','GWEY','VWEY','GGEY','GVEY','VVEY')
