...
#' been completely reduced, removing all resistance alleles. After that, there are
#' 5 possible alleles:
#' \itemize{
...
#' }
#'
#' This provides a total genotype count of 14, however, there are only 10 viable
#' female genotypes and 4 viable male genotypes.
#'
...
#' @export
cubeSEMcisXreduct1 <- function(pF=1,
                               aF=1, cF=1,
                               mmrF=0, mmrM=0,
                               pDep=0,
  ...
  ## safety checks
  inputVec <- c(pF, aF,cF, mmrF,mmrM, pDep)
