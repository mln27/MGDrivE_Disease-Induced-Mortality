...
make_female_inf_epi_haz_decoupled_SIS <- function(trans,u,cube,params,exact = TRUE,
                                                  tol = 1e-8,h_ix = NULL){
...
make_female_inf_epi_haz_decoupled_Imperial <- function(trans,u,cube,params,exact = TRUE,
                                                       tol = 1e-8,h_ix = NULL) {
  # which places have input arcs to this transition
  s <- trans$s
