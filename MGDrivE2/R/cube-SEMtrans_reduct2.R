...
#' one resistance allele associated with SEM. Therefore, there are 4 possible alleles at the first site:
#' \itemize{
...
#' }
#'
#' This provides a total genotype count of 60. Genotypes are written (site 1)(site 1)(site 2)(site 2).
...
#' @export
cubeSEMtransReduct2 <- function(pF=1,
                                aF=1, bF=1, cF=1,
                                xF=1,
                                pM=pF,
                                aM=aF, bM=bF, cM=cF,
  ...
  genotypes <- c('WWWW','GWWW','VWWW','SWWW','GGWW','GVWW','GSWW','VVWW','SVWW',
                 'SSWW','WWHW','GWHW','VWHW','SWHW','GGHW','GVHW','GSHW','VVHW',
                 'SVHW','SSHW','WWEW','GWEW','VWEW','SWEW','GGEW','GVEW','GSEW',
                 'VVEW','SVEW','SSEW','WWHH','GWHH','VWHH','SWHH','GGHH','GVHH',
                 'GSHH','VVHH','SVHH','SSHH','WWEH','GWEH','VWEH','SWEH','GGEH',
                 'GVEH','GSEH','VVEH','SVEH','SSEH','WWEE','GWEE','VWEE','SWEE',
                 'GGEE','GVEE','GSEE','VVEE','SVEE','SSEE')
