...
#' }
#'
#' This provides a total genotype count of 35, however, there are only 28 viable
#' female genotypes and 7 viable male genotypes.
#'
...
#' @export
cubeSEMcisX <- function(pF=1, qF=1, rF=0,
                        aF=1, bF=1, cF=1,
                        mmrF=0, mmrM=0,
