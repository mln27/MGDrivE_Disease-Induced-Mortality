...
#' our model is a single-node metapopulation of mosquito; This function has no
...
#' \code{\link{equilibrium_SEI_decoupled_mosy}} and \code{\link{equilibrium_Imperial_decoupled}}.
#'
#' While this function produces all structural information related to transitions,
#' hazards are produced by a separate function, \code{\link{spn_hazards_decoupled}}.
...
#'
#' @export
spn_T_epi_decoupled_node <- function(spn_P,params,cube,feqTol=1.5e-08){
...
spn_T_both_epi_decoupled <- function(u,nE,nL,nP,nEIP,cube,node_id,T_index,feqTol){
