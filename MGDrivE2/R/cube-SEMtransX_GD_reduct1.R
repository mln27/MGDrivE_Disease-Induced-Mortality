...
#' been completely reduced, removing all resistance alleles. There are 4 possible alleles at the first site:
#' \itemize{
...
#' }
#'
#' This provides a total genotype count of 54 in the cube, however, only 36 viable
...
#' @export
cubeSEMtransX_GDReduct1 <- function(pF=1,
                                    aF=1, cF=1,
                                    xF=1,
                                    aM=aF, cM=cF,
                                    xM=xF,
  ...
  genoF <- c('XXWW','GXWW','VXWW','GGWW','GVWW','VVWW','XXHW','GXHW','VXHW','GGHW','GVHW',
             'VVHW','XXEW','GXEW','VXEW','GGEW','GVEW','VVEW','XXHH','GXHH','VXHH','GGHH',
             'GVHH','VVHH','XXEH','GXEH','VXEH','GGEH','GVEH','VVEH','XXEE','GXEE','VXEE',
             'GGEE','GVEE','VVEE')
  genoM <- c('XYWW','GYWW','VYWW','XYHW','GYHW','VYHW','XYEW','GYEW','VYEW','XYHH','GYHH',
             'VYHH','XYEH','GYEH','VYEH','XYEE','GYEE','VYEE')
